...
local function nvim_tree_on_attach(bufnr)
	...
	local nvim_tree_detatch = vim.api.nvim_create_augroup("nvim_tree_detatch", { clear = true })
	vim.api.nvim_set_option_value("winblend", OPACITY, { win = win })
	vim.api.nvim_set_hl(0, "Cursor", { fg = "#080808", bg = "#9e9e9e", blend = 100, force = true })
	...
	vim.api.nvim_create_autocmd("BufLeave", {
		...
		callback = function()
			vim.api.nvim_set_hl(0, "Cursor", { fg = "#080808", bg = "#9e9e9e", blend = 0, force = true })
